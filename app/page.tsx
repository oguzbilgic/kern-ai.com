    ...
    <main className="min-h-screen">
      ...
      <nav className="px-6 py-4 max-w-5xl mx-auto flex items-center justify-between">
        ...
        <div className="flex gap-4 text-sm text-[var(--muted)]">
          ...
          <a href="https://app.kern-ai.com" className="bg-[var(--accent)] text-black text-xs font-semibold rounded px-2.5 py-1 hover:opacity-90 transition-opacity">Web UI</a>
