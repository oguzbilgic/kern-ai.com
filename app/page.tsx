    ...
    <main className="min-h-screen">
      ...
      <nav className="px-6 py-4 max-w-5xl mx-auto flex items-center justify-between">
        ...
        <div className="flex gap-4 text-sm text-[var(--muted)]">
          ...
          <a href="https://app.kern-ai.com" className="border border-[var(--border)] rounded-full px-3 py-0.5 text-[var(--fg)] hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors">Web UI</a>
      ...
      <section className="px-6 pt-24 pb-16 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
          ...
          <a href="https://app.kern-ai.com" className="border border-[var(--border)] rounded-lg px-5 py-3 text-sm inline-flex items-center gap-2 text-[var(--muted)] hover:text-[var(--fg)] hover:border-[var(--fg)] transition-colors">
            Open Web UI →
          </a>
        </div>
